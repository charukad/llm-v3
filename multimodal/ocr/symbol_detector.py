...
# Add SymbolDetector class
class SymbolDetector:
    """
    Class for detecting mathematical symbols in images.
    """
    ...
    @staticmethod
    def get_symbol_text(symbol_data: Dict[str, Any]) -> str:
        """
        Get the text representation of a symbol.
        ...
        """
        return symbol_data.get("text", "")
    
    @staticmethod
    def get_confidence(symbol_data: Dict[str, Any]) -> float:
        """
        Get the confidence score for a symbol.
        
        Args:
            symbol_data: Symbol data dictionary
            
        Returns:
            Confidence score for the symbol
        """
        return symbol_data.get("confidence", 0.0)
