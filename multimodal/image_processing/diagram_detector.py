...
# Add DiagramDetector class
class DiagramDetector:
    """Detector for mathematical diagrams in images."""
    ...
    def detect(image_path: str) -> Dict[str, Any]:
        ...
        Returns:
            Dictionary containing detected diagrams
        """
        return detect_diagrams(image_path)
    
    @staticmethod
    def classify_diagram(diagram_data: Dict[str, Any]) -> str:
        """
        Classify a diagram based on its properties.
        ...
        """
        if not diagram_data or "type" not in diagram_data:
            return "unknown"
            
        diagram_type = diagram_data.get("type")
        
        if diagram_type == "geometric":
            return f"geometric_{diagram_data.get('shape', 'shape')}"
        elif diagram_type == "line_diagram":
            return "line_diagram"
        else:
            return "unknown"
